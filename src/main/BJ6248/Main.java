...
public class Main {
    ...
    private void run() {
        Input ip = readInput();
        System.out.println(new Solution().solution(ip.numOfNodes, ip.edges, ip.startNode));
    }
...
class Solution {
    ...
    public int solution(int numOfNodes, int[][] edges, int startNode) {
    ...
    private void calc(int startNode) {
        ...
        pq.offer(new int[] {startNode, 0}); // node, cost
        dist[startNode] = 0;
